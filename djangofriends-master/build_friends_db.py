...
first_names = ["Noah", "Liam", "Mason", "Jacob", "William", "Ethan", "Michael", "Alexander", "James", "Daniel", "Emma",
...
for count in range(15):
    ...
    mysql.run_mysql_query(
        "INSERT INTO friends.friendships (user_id, friend_id, created_at, updated_at) VALUES ({}, {}, NOW(), NOW())".format(
            user, friend))
    mysql.run_mysql_query(
        "INSERT INTO friends.friendships (user_id, friend_id, created_at, updated_at) VALUES ({}, {}, NOW(), NOW())".format(
            friend, user))
...
for user, friend in random.sample(relationships, 20):
    mysql.run_mysql_query(
        "INSERT INTO friendships (user_id, friend_id, created_at, updated_at) VALUES ({}, {}, NOW(), NOW())".format(
            user, friend))
